            ...
            <section className={`h-[300vh] flex justify-between items-center flex-col w-full  mt-10`}>
                <motion.div
                    ...
                    <div className={`bg-white/10 p-6 backdrop-blur-2xl flex-1 h-full`}>
                        <UnderlineHeading text={"Vanshika Garg"}/>
                        <div className={`p-4 text-justify`}>
                            Meet Vanshika Garg, the driving force behind our front-end development team. With her
                            ...
                            GitHub repositories, ensuring smooth collaboration and version control. Vanshika's
                ...
                <motion.div
                    ...
                    <div className={`bg-white/10 p-6 backdrop-blur-2xl flex-1 h-full`}>
                        <UnderlineHeading text={"Vansh Sharma"}/>
                        <div className={`p-4 text-justify`}>
                            Vansh Sharma is known for his expertise in Tailwind CSS, a utility-first CSS framework that
                ...
                <motion.div
                    ...
                    <div className={`bg-white/10 p-6 backdrop-blur-2xl flex-1 h-full`}>
                        <UnderlineHeading text={"Uddeshya Singh"}/>
                        <div className={`p-4 text-justify`}>
                            Uddeshya Singh appears to specialize in TypeScript, a statically typed superset of
