                                ...
                                >
                                    <a href={"#lg"}>
                                        <motion.div
                                            ...
                                            className={`border-[0.25px] ${c_backgroundColor === "black" ? `border-white bg-black/80 hover:bg-white hover:text-black` : `border-black bg-white/80 hover:bg-black hover:text-white`} p-4 rounded-full`}>Work
                                            Work With Us
                                        </motion.div>
                                    </a>
                                </motion.div>
